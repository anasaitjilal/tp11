                                ...
                                <ul class="navbar-mobile__list list-unstyled">
                                    <li class="has-sub">
                                        ...
                                        <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                            <li>
                                                <a href="#Departements" class="departement"><i class="zmdi zmdi-hc-1x zmdi-group-work"></i>filieres</a>
                                            </li>
                                            <li>
                                                <a href="#Employés" class="employe"><i class="zmdi zmdi-hc-1x zmdi-accounts"></i>etudiants</a>
                                            </li>
                                            <li>
                                                <a href="#Fonctions" class="fonction"><i class="zmdi zmdi-hc-1x zmdi-settings"></i>classes</a>
                                            </li>
                                            <li>
